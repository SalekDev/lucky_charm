...
public class LuckyCharmTrialVaultsModifiers {
    ...
    static {
        LOOTTABLES = ImmutableMap.<RegistryKey<LootTable>, Function<RegistryWrapper.WrapperLookup, LootTable.Builder>>builder()
                .put(LootTables.TRIAL_CHAMBERS_REWARD_RARE_CHEST, LuckyCharmTrialVaultsModifiers::trialChambersRewardRareChest)
                .put(LootTables.TRIAL_CHAMBERS_REWARD_COMMON_CHEST, LuckyCharmTrialVaultsModifiers::trialChambersRewardCommonChest)
                .put(LootTables.TRIAL_CHAMBERS_REWARD_UNIQUE_CHEST, LuckyCharmTrialVaultsModifiers::trialChambersRewardUniqueChest)
                .put(LootTables.TRIAL_CHAMBERS_REWARD_CHEST, LuckyCharmTrialVaultsModifiers::trialChambersRewardChest)
                .put(LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_RARE_CHEST, LuckyCharmTrialVaultsModifiers::trialChambersRewardOminousRareChest)
                .put(LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_COMMON_CHEST, LuckyCharmTrialVaultsModifiers::trialChambersRewardOminousCommonChest)
                .put(LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_UNIQUE_CHEST, LuckyCharmTrialVaultsModifiers::trialChambersRewardOminousUniqueChest)
                .put(LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_CHEST, LuckyCharmTrialVaultsModifiers::trialChambersRewardOminousChest)
                .put(LootTables.TRIAL_CHAMBER_CONSUMABLES_SPAWNER, LuckyCharmTrialVaultsModifiers::trialChamberConsumablesSpawner)
                .put(LootTables.OMINOUS_TRIAL_CHAMBER_CONSUMABLES_SPAWNER, LuckyCharmTrialVaultsModifiers::ominousTrialChamberConsumablesSpawner)
                .put(LootTables.TRIAL_CHAMBER_ITEMS_TO_DROP_WHEN_OMINOUS_SPAWNER, LuckyCharmTrialVaultsModifiers::trialChambersItemsToDropWhenOminousSpawner)
                .build();
    }
